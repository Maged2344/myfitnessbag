...
# === Step 1: Fill report.xlsx from vendors ===
for row in report_ws.iter_rows(min_row=3, max_row=6):  # Row 3 to 6
    file_name = row[1].value  # Column B
...
print("✅ Report filled and totals calculated.")

# === Step 3: Update monthly report ===
# Load or create the monthly workbook
...
# === Step 4: Remove any existing "Running Total" rows ===
rows_to_delete = []
...
# === Step 6: Append single fresh Running Total ===
...
print("✅ Monthly report updated with only 1 Running Total.")
