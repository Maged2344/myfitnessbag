...
def process_mfa_excel():
    source_wb = openpyxl.load_workbook('mfa-completed.xlsx')
    ...
    target_wb = openpyxl.load_workbook('mfa.xlsx')
    ...
    target_wb.save('mfa.xlsx')
    print("[INFO] Workbook saved after insert/delete operations.")

# ===== Step 2: Refresh Pivot Tables in MFB_Delivery Report =====
def update_mfa_pivot():
    file = "mfa.xlsx"
    data_sheet = "MFB_Delivery"
    report_sheet = "MFB_Delivery Report"
...
if __name__ == "__main__":
    print("\n=== Step 1: Process and Clean mfa.xlsx ===")
    process_mfa_excel()

    print("\n=== Step 2: Update Pivot Tables in mfa.xlsx ===")
    update_mfa_pivot()
