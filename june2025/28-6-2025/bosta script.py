...
# ===== Step 2: Refresh Pivot Tables in BO_Delivery Report =====
def update_bosta_pivot():
    file = "bosta.xlsx"
    data_sheet = "BO_Delivery"
    report_sheet = "BO_Delivery Report"
...
if __name__ == "__main__":
    ...
    print("\n=== Step 2: Update Pivot Tables in bosta.xlsx ===")
    update_bosta_pivot()
